...
func list_storage_objects(collection: String, user_id: String, limit: int, cursor: String):
	var request = {
		method = HTTPClient.METHOD_GET,
...
func list_groups(name: String, limit: int, cursor: String):
	var request = {
		method = HTTPClient.METHOD_GET,
		path = 'v2/group',
		query_string = {},
...
func create_group(name: String, description: String, lang_tag: String, open: bool):
	var request = {
		method = HTTPClient.METHOD_POST,
		path = 'v2/group',
		data = {},
	...
	request['data']['lang_tag'] = lang_tag
	request['data']['open'] = open
...
func list_notifications(limit: int, cursor: String):
	var request = {
		method = HTTPClient.METHOD_GET,
...
func list_channel_messages(channel_id: String, limit: int, cursor: String):
	var request = {
		method = HTTPClient.METHOD_GET,
...
func list_tournament_records(tournament_id: String, owner_ids: Array, limit: int, cursor: String):
	var request = {
		method = HTTPClient.METHOD_GET,
